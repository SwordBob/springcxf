...
public class ServiceImplServiceLocator extends org.apache.axis.client.Service implements com.demo.service.client.ServiceImplService {
    ...
    private java.lang.String ServiceImplPort_address = "http://localhost:8080/serviceserverdemo/IService";
    ...
    public com.demo.service.client.IService getServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.demo.service.client.ServiceImplServiceSoapBindingStub _stub = new com.demo.service.client.ServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.demo.service.client.IService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.demo.service.client.ServiceImplServiceSoapBindingStub _stub = new com.demo.service.client.ServiceImplServiceSoapBindingStub(new java.net.URL(ServiceImplPort_address), this);
                _stub.setPortName(getServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.cxf.test.com/", "ServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.cxf.test.com/", "ServiceImplPort"));
        }
